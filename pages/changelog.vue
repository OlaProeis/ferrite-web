...
const releases = [
  {
    ...
    date: 'May 22, 2026',
    highlights: [
      'Rendered edit session (WYSIWYG block switching)',
      'PDF & themed HTML export',
      'Executable code blocks (shell/Python)',
      'Mermaid first wave: insert toolbar, validation, flowchart polish',
      'eframe/egui 0.34.2 + Rust 1.92 MSRV',
      'Phosphor icon set — full UI refresh',
      'Split-view scroll sync',
      'Quick note workflow',
      'Workspace file index (Ctrl+P / Ctrl+Shift+F)',
